...
public class JedisAdapter implements InitializingBean{
    ...
    public List<String> lrange(String key, int start, int end) {
        ...
        try {
            ...
            logger.error("返回指定区间元素发生异常" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public long zadd(String key,double score,String value){
        ...
        try {
            ...
            logger.error("加入集合异常" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public long zrem(String key,String value){
        ...
        try {
            ...
            logger.error("移除集合异常" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public Transaction multi(Jedis jedis){
        try{
            ...
            logger.error("事务异常"+e.getMessage());
        }
        return null;
    }
    ...
    public Set<String> zrange(String key, int start, int end){
        ...
        try {
            ...
            logger.error("获取集合异常" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public Set<String> zrevrange(String key, int start, int end){
        ...
        try {
            ...
            logger.error("倒序获取集合异常" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public long zcard(String key){
        ...
        try {
            ...
            logger.error("获取集合元素个数异常" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public Double zscore(String key,String member){
        ...
        try {
            ...
            logger.error("获取元素分值异常" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
